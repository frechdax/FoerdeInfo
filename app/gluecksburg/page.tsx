...
export default function HomePage() {
  ...
  function downloadEventIcs(event: EventRow) {
    const lines = [
      "BEGIN:VCALENDAR",
      "VERSION:2.0",
      "PRODID:-//förde.info//Veranstaltungen//DE",
      "CALSCALE:GREGORIAN",
      "METHOD:PUBLISH",
      "BEGIN:VEVENT",
  ...
  const navItems: Array<{ id: View; label: string; symbol: string; href: string }> = [
    { id: "home", label: "Glücksburg", symbol: "🏠", href: "/gluecksburg" },
    { id: "events", label: "Veranstaltungen", symbol: "📅", href: "/gluecksburg#events" },
    { id: "urlaub", label: "Urlaub", symbol: "🌊", href: "/gluecksburg#urlaub" },
    { id: "impressum", label: "Impressum", symbol: "📄", href: "/gluecksburg#impressum" },
  ];
    ...
    <>
      ...
      <aside className="sidebar">
        <button className="brand" onClick={() => navigate("home")}>
          ...
          <span>förde.info</span>
        </button>

        <div className="sidebar-location">⌖ GLÜCKSBURG (OSTSEE)</div>

        <nav>
          <a className="nav-item" href="/orte/flensburg">
            {icon("⚓")}
            <span>Flensburg</span>
          </a>
          {navItems.map((item) => (
        ...
        <main className="main" id="content">
          ...
          {view === "home" && (
            <>
              ...
              <section className="region-link-card" aria-labelledby="region-link-title">
                <div>
                  <span className="pharmacy-tile-label">Flensburger Förde</span>
                  <h2 id="region-link-title">Jetzt auch Flensburg entdecken</h2>
                  <p>Veranstaltungen, Freizeit und praktische Anlaufstellen für Flensburg.</p>
                </div>
                <a className="button primary" href="/orte/flensburg">Zu Flensburg →</a>
              </section>
                ...
                <section className="travel-feature-card">
                  ...
                  <div className="travel-feature-copy">
                    ...
                    {stay22AffiliateEnabled ? (
                      <small>
                        Affiliate-Link über Stay22. Bei einer Buchung kann förde.info eine
              ...
              {view === "urlaub" && (
                <>
                  ...
                  <p className="travel-note">
                    förde.info vermittelt keine Unterkünfte und ist nicht Vertragspartner
          ...
          {view === "impressum" && (
            <>
              ...
              <section className="card padded legal-card">
                ...
                <p className="muted">
                  förde.info ist ein privat betriebenes, unabhängiges Informationsangebot.
                  Es handelt sich nicht um eine Website, App oder sonstige Veröffentlichung der
                  Stadt Glücksburg (Ostsee), der Stadt Flensburg, der Gemeinden Harrislee und Langballig, des Amtes, des Kreises Schleswig-Flensburg, der ASF
                ...
                <p>
                  Die auf förde.info dargestellten Inhalte dienen der schnellen Orientierung.
                ...
                <ul className="legal-list">
                  ...
                  <li>
                    ...
                    förde.info ersetzt keine amtliche Veröffentlichung.
                  </li>
                  <li>
                ...
                <h2>Externe Links</h2>
                <p>
                  förde.info enthält Links zu Websites Dritter. Auf deren Inhalte und
                ...
                <p>
                  förde.info nutzt Vercel Web Analytics zur Auswertung von Seitenaufrufen,
                  Besucherzahlen, Referrern, Geräte- und Browserinformationen sowie ausgewählten
                  Interaktionen, beispielsweise dem Öffnen eines Bereichs. Straßennamen oder
                  andere Adressangaben werden nicht als Analyseereignisse an Vercel übermittelt.
                </p>
                <p>
                  Vercel Web Analytics wird auf förde.info erst geladen, wenn du im
                ...
                <p>
                  förde.info nutzt Google Analytics 4 von Google zur Auswertung der Nutzung
                ...
                <p>
                  ...
                  Adressangaben werden nicht gezielt als Analyseparameter an Google Analytics
                  übermittelt.
                </p>
                <p>
                  <a
                ...
                <p>
                  Anbieter des Dienstes ist Google. Der AdSense-Code ist auf förde.info
                  technisch vorbereitet, derzeit aber deaktiviert; solange die Werbeeinbindung
                  nicht aktiviert ist, werden über förde.info keine
                ...
                <p>
                  ...
                  förde.info und Google hinsichtlich bestimmter Verarbeitungen jeweils als
                ...
                <p>
                  Zum Speichern deiner Datenschutz-Auswahl nutzt förde.info den Local Storage
                  des Browsers. Diese Speicherung dient der Bereitstellung der gewählten
                  Einstellungen. Vercel Web Analytics wird erst nach
                ...
                <p>
                  ...
                  Glücksburg oder den gewählten Ort übertragen – nicht der aktuelle Standort des Nutzers. Wie bei jeder
                ...
                <p>
                  Im Bereich Unterkünfte verwendet förde.info Affiliate-Links des Anbieters
          ...
          <footer className="site-footer">
            <nav className="footer-seo-links" aria-label="Orte an der Förde">
              <a href="/orte/flensburg">Flensburg</a>
              <a href="/">Alle Orte</a>
            </nav>
            <div className="footer-note">
              <span>förde.info ist ein privates, unabhängiges Informationsangebot.</span>
