...
export const metadata: Metadata = {
  title: {
    absolute: "Partner werden – lokale Sichtbarkeit an der Förde | förde.info",
  },
  description:
    "Lokaler Betrieb in Flensburg, Wassersleben, Glücksburg oder Langballig? Kontakt für regionale Kooperationen auf förde.info.",
  alternates: { canonical: "/partner" },
};

const contactHref =
  "mailto:sebastianschwarz1@icloud.de?subject=Partnerschaft%20mit%20foerde.info";
    ...
    <main className={styles.page}>
      <div className={styles.shell}>
        ...
        <section className={styles.hero}>
          ...
          <h1>Mit förde.info Menschen an der Förde erreichen</h1>
          <p>
            förde.info verbindet Informationen zu Wetter, Strand, Veranstaltungen
        ...
        <section className={styles.grid}>
          ...
          <article className={styles.card}>
            ...
            <p>
              Die Zielgruppe sucht nach Flensburg, Wassersleben, Glücksburg, Langballig, Freizeit,
