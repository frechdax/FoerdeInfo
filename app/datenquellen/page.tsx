  ...
  return (
    <main className="info-page"><div className="info-shell">
      ...
      <div className="prose">
        ...
        <h2>Flensburg GPS</h2>
        <p>Aktiv Bus betreibt einen eigenen öffentlichen Busradar. BusRadar liest diesen Webdienst nicht automatisiert aus, weil dessen Nutzungsbedingungen eine solche Integration ohne ausdrückliche Genehmigung nicht erlauben. Der GPS-Provider wird erst aktiviert, wenn ein separat freigegebener Fahrzeugpositions-Endpunkt vorliegt.</p>
